...
"The Pakistan's Himalayan foothills",
  ...
  const isGeographyQuestion = (input) => {
  ...
  const handleSearch = async () => {
    ...
    // Check if the question is related to geography
    if (!isGeographyQuestion(question)) {
      setAnswer("Please ask a geography-related question.");
      return;
    }
  ...
  return (
    <div className={styles.chatbotContainer}>
      ...
      <h2 className={styles.chatbotTitle}>Geography Chatbot</h2>
      <br /><br />
      <p className={styles.description}>
        I can answer questions related to geography, such as countries, climates, rivers, mountains, and more.
      </p>
      <textarea
        className={styles.textarea}
        placeholder="Ask me a geography question (e.g., 'What is the largest desert?')"
        value={question}
